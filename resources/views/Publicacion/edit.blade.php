		...
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Editar Publicacion</h3>
				</div>
				<div class="panel-body">					
					<div class="table-container">
						<form method="POST" action="{{ route('publicacion.update',$publicacion->id) }}"  role="form">
							{{ csrf_field() }}
							<input name="_method" type="hidden" value="PATCH">
							<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										  <label for="resumen">Fecha Publicacion</label>
										<input type="date" name="fechaPublicacion" id="fechaPublicacion" class="form-control input-sm" placeholder=">Fecha Publicacion" value="{{$publicacion->fechaPublicacion}}">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										  <label for="resumen">Titulo Repositorio</label>
										<select name="idRepositorio" class="selectpicker" >{{$publicacion->idRepositorio}}
							...
							<div class="form-group">
								...
								<textarea name="observacion" class="form-control input-sm" placeholder="Observacion" >{{$publicacion->observacion}}</textarea> 
							</div>
							<div class="row">
